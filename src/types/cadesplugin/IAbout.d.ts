...
export interface IAbout {
     ...
     */
    ReaderFilter(EnabledTypes: number, EnabledOperations: number, strFilterRegexp: string): WithOptionalPromise<void>;
    /**
     * Возвращает объект IVersion c версией криптопровайдера (CSP) производства компании Крипто-Про.
     */
    CSPVersion(providerName?: string, providerType?: number): WithOptionalPromise<IVersion>;
    /**
