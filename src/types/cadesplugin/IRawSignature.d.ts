...
export interface IRawSignature {
     ...
     */
    SignHash(hashedData: CPHashedData, certificate: ICertificate): WithOptionalPromise<string>;
    /**
     ...
     */
    VerifyHash(hashedData: CPHashedData, certificate: ICertificate, rawSignature: string): WithOptionalPromise<void>;
}
