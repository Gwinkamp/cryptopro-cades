...
export type CadesSignedData = {
     ...
     */
    SignCades(signer: CPSigner, cadesType: CADESCOM_CADES_TYPE, bDetached?: boolean): WithOptionalPromise<string>;
    /**
     * Создает усовершенствованную подпись.
     ...
     */
    SignHash(hashData: CPHashedData, signer: CPSigner, cadesType: CADESCOM_CADES_TYPE): WithOptionalPromise<string>;
};
