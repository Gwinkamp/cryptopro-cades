...
export function createObject(objectIdentifier) {
    var _this = this;
    return afterPluginLoaded(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!objectIdentifier) {
                        throw CryptoError.create('CBP-7', 'Не указан идентификатор объекта', null);
                    }
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    ...
                    return [4 /*yield*/, unwrap(object)];
                case 2: return [2 /*return*/, _a.sent()];
                case 3:
                    error_1 = _a.sent();
                    throw CryptoError.createCadesError(error_1, "\u041E\u0448\u0438\u0431\u043A\u0430 \u043F\u0440\u0438 \u0441\u043E\u0437\u0434\u0430\u043D\u0438\u0438 \u043E\u0431\u044A\u0435\u043A\u0442\u0430 ".concat(objectIdentifier));
