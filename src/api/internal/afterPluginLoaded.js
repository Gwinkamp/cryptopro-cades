 ...
 */
export function afterPluginLoaded(cb, checkSystem) {
    var _this = this;
    if (checkSystem === void 0) { checkSystem = false; }
    return function () {
        var args = [];
        ...
        return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!!isPluginReady) return [3 /*break*/, 2];
                        return [4 /*yield*/, checkPlugin()];
                    case 1:
                        _a.sent();
                        isPluginReady = true;
                        _a.label = 2;
                    case 2:
                        ...
                        if (!(checkSystem && PluginConfig.CheckSystemSetup && !isPluginReady)) return [3 /*break*/, 4];
                        return [4 /*yield*/, checkIsValidSystemSetup()];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4: return [4 /*yield*/, unwrap(cb.apply(null, args))];
                    case 5:
