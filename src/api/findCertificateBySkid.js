 ...
 */
export function findCertificateBySkid(subjectKeyId) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!subjectKeyId) {
                        errorMessage = 'Не указан идентификатор ключа субъекта искомого сертификата.';
                        throw CryptoError.create('CBP-7', errorMessage, null, errorMessage);
                    }
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, getCertificates()];
                case 2: return [2 /*return*/, (_a.sent()).find(function (c) { return c.subjectKeyId == subjectKeyId; })];
                case 3:
                    err_1 = _a.sent();
