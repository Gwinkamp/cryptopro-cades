 ...
 */
export declare enum CADESCOM_XML_SIGNATURE_TYPE {
    /**
     * Вложенная подпись.
     */
 ...
 */
export declare enum CADESCOM_XADES_TYPE {
    /**
 ...
 */
export declare const enum CADESCOM_CADES_TYPE {
    /**
 ...
 */
export declare enum XML_SIGNATURE_GOST_ALGORITHM_TYPE {
    /**
 ...
 */
export declare enum CAPICOM_CERTIFICATE_INCLUDE_OPTION {
    /**
 ...
 */
export declare enum CADESCOM_ENCODING_TYPE {
    /**
 ...
 */
export declare enum CAPICOM_ENCODING_TYPE {
    /**
     * Data is saved as a base64-encoded string or a pure binary sequence. This encoding type is used only for input data that has an unknown encoding type. Introduced in CAPICOM 2.0.
     */
    CAPICOM_ENCODE_ANY = 4294967295,
    /**
     * Data is saved as a base64-encoded string.
     */
 ...
 */
export declare enum CAPICOM_STORE_OPEN_MODE {
    /**
 ...
 */
export declare enum STORE_LOCATION {
    /**
 ...
 * @type {number}
 */
export declare enum CAPICOM_CERT_INFO_TYPE {
    /**
 ...
 * @type {number}
 */
export declare enum CAPICOM_CERTIFICATE_FIND_TYPE {
    /**
 ...
 * @type {number}
 */
export declare enum CAPICOM_KEY_USAGE {
    /**
...
export declare const CADESCOM_AUTHENTICATED_ATTRIBUTE_MACHINE_INFO = 256;
 ...
 */
export declare enum CADESCOM_ENCRYPTION_ALGORITHM {
    /**
     * Алгоритм RSA RC2.
     */
 ...
 */
export declare enum CADESCOM_HASH_ALGORITHM {
    /**
     * Алгоритм SHA1.
     */
...
export declare const CADESCOM_InstallCertChainToContainer = 536870912;
export declare const CADESCOM_UseContainerStore = 1073741824;
export declare const ENABLE_CARRIER_TYPE_CSP = 1;
export declare const ENABLE_CARRIER_TYPE_FKC_NO_SM = 2;
export declare const ENABLE_CARRIER_TYPE_FKC_SM = 4;
export declare const ENABLE_ANY_CARRIER_TYPE = 7;
export declare const DISABLE_EVERY_CARRIER_OPERATION = 0;
export declare const ENABLE_CARRIER_OPEN_ENUM = 1;
export declare const ENABLE_CARRIER_CREATE = 2;
export declare const ENABLE_ANY_OPERATION = 3;
export declare const CADESCOM_PRODUCT_CSP = 0;
export declare const CADESCOM_PRODUCT_OCSP = 1;
export declare const CADESCOM_PRODUCT_TSP = 2;
/**
 * Тип медиа.
 * @see https://docs.cryptopro.ru/cades/reference/cadescom/cadescom_enum/cadescom_media_type
 */
export declare const enum CADESCOM_MEDIA_TYPE {
    /**
     * Реестр.
     */
...
export declare const XCN_CRYPT_STRING_BASE64HEADER = 0;
export declare const AT_KEYEXCHANGE = 1;
export declare const AT_SIGNATURE = 2;
export declare const CARRIER_FLAG_REMOVABLE = 1;
export declare const CARRIER_FLAG_UNIQUE = 2;
export declare const CARRIER_FLAG_PROTECTED = 4;
export declare const CARRIER_FLAG_FUNCTIONAL_CARRIER = 8;
export declare const CARRIER_FLAG_SECURE_MESSAGING = 16;
export declare const CARRIER_FLAG_ABLE_VISUALISE_SIGNATURE = 64;
export declare const CARRIER_FLAG_VIRTUAL = 128;
/**
 ...
 */
export declare const enum CRYPTO_OBJECTS {
    /**
